...
namespace SeminarioTickets
{
    public partial class TipoEvento : Form
    {
        ...
        {
            conexion.Modificaciones("exec InsercionTipoEventos '" + txtID.Text + "', '" + NomEvn.Text + "'");
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            conexion.Modificaciones("EXEC UpdateTipoEventos '" + idEvn + "', '" + nuevoNombre + "'");
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (confirmResult == DialogResult.Yes)
            {
                ...
                conexion.Modificaciones("EXEC DeleteTipoEventos '" + idEvn + "'");
